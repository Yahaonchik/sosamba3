  ...
  return (
    <>
      <div className={`inline-cta ${className}`} onClick={onClick}>
        <img alt="image" src="/ICONS/29.svg" loading="lazy" className="inline-cta__icon" />
        <strong className="inline-cta__text">Вызвать мастера</strong>
      </div>
      <style jsx>{`
        .inline-cta { gap: 4px; width: 100%; display: flex; transition: transform 0.2s ease, background-color 0.2s ease; border-radius: 4px; padding: 4px; cursor: pointer; }
