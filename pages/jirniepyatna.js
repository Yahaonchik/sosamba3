...
const Page = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      imageCaption: '',
      content:
        `<p>Если домашние средства не помогли — используйте пятновыводители: гели, спреи, мыло. Выбирайте по типу ткани (белые, цветные, деликатные), строго следуйте инструкции и предварительно тестируйте на незаметном участке.</p><p>Комбинация быстрых мер и одного из переч��сленных методов обычно убирает жирные следы без вреда для ткани.</p>`
    },
  ]
