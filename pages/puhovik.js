...
const Page = () => {
  ...
  const structuredData = getArticleStructuredData(
    'Как правил��но стирать пуховик',
    'Инстр��кция по стирке и сушке пуховика в машинке: режим, моющее, восстановление объема',
    `${baseUrl}/puhovik`,
