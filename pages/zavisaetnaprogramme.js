...
const Page = () => {
  ...
  const anchors = {
    ...
    items: [
      ...
      { icon: '/vector.svg', href: '#2', text: 'Другие воз��ожные причины:' },
